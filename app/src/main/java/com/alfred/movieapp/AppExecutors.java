...
import static com.alfred.movieapp.utilities.Constant.NUMBER_OF_THREADS_THREE;
...
public class AppExecutors {
    ...
    public static com.alfred.movieapp.AppExecutors getInstance() {
        if (sInstance == null) {
            synchronized (LOCK) {
                sInstance = new com.alfred.movieapp.AppExecutors(Executors.newSingleThreadExecutor(),
