...
public class MovieSearchDataSource extends PageKeyedDataSource<Integer, Movie> {
    ...
    /** Tag for logging */
    private static final String TAG = MovieSearchDataSource.class.getSimpleName();
    ...
    public MovieSearchDataSource(String search) {
    ...
    public void loadInitial(@NonNull LoadInitialParams<Integer> params,
        ...
        mTheMovieApi.getSearchMovies(mSearch, Constant.API_KEY, Constant.LANGUAGE, Constant.PAGE_ONE)
    ...
    public void loadAfter(@NonNull LoadParams<Integer> params,
        ...
        mTheMovieApi.getSearchMovies(mSearch, Constant.API_KEY, Constant.LANGUAGE, currentPage)
                .enqueue(new Callback<MovieResponse>() {
                    @Override
                    public void onResponse(Call<MovieResponse> call, Response<MovieResponse> response) {
                        if (response.isSuccessful()) {
